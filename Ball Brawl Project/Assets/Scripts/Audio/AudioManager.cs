...
public class AudioManager : NetworkBehaviour {
    ...
    public static void PlayEvent(string eventString, GameObject gameObject, bool attach = false, bool instantDelete = true, bool allowDuplicates = true) {
        if (!allowDuplicates && checkForDuplicate(eventString, gameObject)) {
            //Do nothing
        } else {
    ...
    private static bool checkForDuplicate(string eventString, GameObject gameObject) {
